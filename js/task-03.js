...
const createElement = image => `<li><img src = "${image.url}"  alt = "${image.alt}" width ="300"></img></li>`;

const allElements = images.map(createElement).join('');

list.insertAdjacentHTML('beforeend', allElements);